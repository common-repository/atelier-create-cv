    ...
    <div id="preview-body" class="preview-body">
        ...
        <div id="preview-sidebar" class="preview-sidebar">
            <div class="sidebar-window">
                ...
                ?>
                <div class="image-box">
                    <img id="prv-img-author" src="<?php echo esc_url((!empty($img)) ? $img : $imgAnonim); ?>" alt="Image Author CV" <?php $prvSq = get_option('atl_cv_square_img'); ?>
                    class="<?php echo esc_attr(($prvSq == 1) ? 'square-img' : 'circle-img'); ?>">
                </div>


                <!-- Title -->
                <h2 class="atl-prv-title"><?php esc_html_e('DANE OSOBOWE','atelircv'); ?></h2>

                <!-- Name && Surname -->
                <div class="data-group">
                    <h4><?php esc_html_e('Imię i Nazwisko','ateliercv'); ?></h4>
                    <div class="flex">
                ...
                <!-- Address -->
                <div class="data-group">
                    <h4><?php esc_html_e('Adres','ateliercv'); ?></h4>
	            ...
	            if(!empty($repo)) { ?>
                    <div class="data-group">
                        <h4><?php esc_html_e('Repozytorium','ateliercv'); ?></h4>
                ...
                if(!empty($website)) { ?>
                    <div class="data-group">
                        <h4><?php esc_html_e('Strona Internetowa','ateliercv'); ?></h4>
        ...
        <div id="content-preview" class="content-preview">
            <div class="content-window">
                ...
                <div class="title-qf">
                    ...
                    <h2><?php esc_html_e('DOŚWIADCZENIE ZAWODOWE','ateliercv'); ?></h2>
                </div>
				...
				<?php foreach ( $result as $item ) {
                    ...
                    $end_date = ($date == '0000-00-00') ? 'Do chwili obecnej.' :  $AtelierCv->changeDateMonth($item->end_date,'/');
                    ...
                    <div class="container-experience">
                        ...
                        <div class="pex-delete">
                            <button class="btn-delete pe-delete" value="<?php echo intval($item->id); ?>"><?php esc_html_e('Usuń','ateliercv'); ?></button>
                        </div>
                ...
                <div class="title-edu">
                    <i class="icon-book"></i>
                    <h2><?php esc_html_e('WYKSZTAŁCENIE I KWALIFIKACJE','ateliercv'); ?></h2>
                </div>
				...
				foreach ($result2 as $school) {
                    ...
                    <div class="container-school">
                        ...
                        <div class="date-col">
                            <div class="date-box">
                                <span><?php echo esc_html($AtelierCv->changeDateMonth($school->start_date,'/') . 'r. - ' . $AtelierCv->changeDateMonth($school->end_date,'/') . 'r.'); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="sch-delete">
                            <button class="edu-delete" value="<?php echo intval($school->id); ?>"><?php esc_html_e('Usuń','ateliercv'); ?></button>
                        </div>
                ...
                foreach ($result3 as $lang) { ?>
                    ...
                    <div class="lang-container">
                        ...
                        <!-- Delete language -->
                        <div id="lang-delete">
                            <button class="lang-delete" value="<?php echo intval($lang->id); ?>"><?php esc_html_e('Usuń','ateliercv'); ?></button>
                        </div>
                ...
                <div class="main-curse curse-container">
                    ...
                    foreach ( $result4 as $curse ) { ?>
                        <div class="curse-row">
                            ...
                            <!-- Delete curse -->
                            <div id="curse-delete">
                                <button class="curse-delete" value="<?php echo intval($curse->id); ?>"><?php esc_html_e('Usuń','ateliercv'); ?></button>
                            </div>
                ...
                ?>
                    <div class="title-skill">
                        <i class="icon-star"></i>
                        <h2><?php esc_html_e('UMIEJIĘTNOŚCI','ateliercv'); ?></h2>
                    </div>
                    <div class="skill-box">
                ...
                ?>
                    ...
                    <div class="title-skill">
                        ...
                        <h2><?php esc_html_e('ZAINTERESOWNIA','ateliercv'); ?></h2>
                    </div>
                    <div class="skill-box">
                    <div class="content-skill">
                        <div class="circle-box"></div>
                ...
                <div class="pp-container">
                    <div class="pp-box">
                        <div class="circle-box"></div>
                        <span><?php
			                $prpol = 'Wyrażam zgodę na przetwarzanie moich danych osobowych dla potrzeb niezbędnych do realizacji
                                procesu rekrutacji (zgodnie z ustawą z dnia 10 maja 2018 roku o ochronie danych osobowych (Dz.
                                Ustaw z 2018, poz. 1000) oraz zgodnie z Rozporządzeniem Parlamentu Europejskiego i Rady
